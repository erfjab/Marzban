...
def user_subscription(
    ...
    if re.match(
        r"^([Cc]lash-verge|[Cc]lash[-\.]?[Mm]eta|[Ff][Ll][Cc]lash|[Mm]ihomo)",
        user_agent,
    ):
        ...
        r"^(SFA|SFI|SFM|SFT|[Kk]aring|[Hh]iddify[Nn]ext)|.*sing[-b]?ox.*",
        user_agent,
        re.IGNORECASE,
    ):
        conf = generate_subscription(
    ...
    elif (USE_CUSTOM_JSON_DEFAULT or USE_CUSTOM_JSON_FOR_HAPP) and re.match(
