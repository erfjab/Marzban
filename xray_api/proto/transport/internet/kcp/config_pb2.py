...
MTU = _reflection.GeneratedProtocolMessageType(
    "MTU",
    (_message.Message,),
    {
        "DESCRIPTOR": _MTU,
...
TTI = _reflection.GeneratedProtocolMessageType(
    "TTI",
    (_message.Message,),
    {
        "DESCRIPTOR": _TTI,
...
UplinkCapacity = _reflection.GeneratedProtocolMessageType(
    "UplinkCapacity",
    (_message.Message,),
    {
...
DownlinkCapacity = _reflection.GeneratedProtocolMessageType(
    "DownlinkCapacity",
    (_message.Message,),
    {
...
WriteBuffer = _reflection.GeneratedProtocolMessageType(
    "WriteBuffer",
    (_message.Message,),
    {
...
ReadBuffer = _reflection.GeneratedProtocolMessageType(
    "ReadBuffer",
    (_message.Message,),
    {
...
ConnectionReuse = _reflection.GeneratedProtocolMessageType(
    "ConnectionReuse",
    (_message.Message,),
    {
...
EncryptionSeed = _reflection.GeneratedProtocolMessageType(
    "EncryptionSeed",
    (_message.Message,),
    {
