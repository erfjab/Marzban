...
TransportConfig = _reflection.GeneratedProtocolMessageType(
    "TransportConfig",
    (_message.Message,),
    {
...
StreamConfig = _reflection.GeneratedProtocolMessageType(
    "StreamConfig",
    (_message.Message,),
    {
...
SocketConfig = _reflection.GeneratedProtocolMessageType(
    "SocketConfig",
    (_message.Message,),
    {
