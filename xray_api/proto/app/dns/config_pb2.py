...
NameServer = _reflection.GeneratedProtocolMessageType(
    "NameServer",
    (_message.Message,),
    {
        "PriorityDomain": _reflection.GeneratedProtocolMessageType(
            "PriorityDomain",
            (_message.Message,),
            {
        ...
        "OriginalRule": _reflection.GeneratedProtocolMessageType(
            "OriginalRule",
            (_message.Message,),
            {
...
Config = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "HostsEntry": _reflection.GeneratedProtocolMessageType(
            "HostsEntry",
            (_message.Message,),
            {
        ...
        "HostMapping": _reflection.GeneratedProtocolMessageType(
            "HostMapping",
            (_message.Message,),
            {
