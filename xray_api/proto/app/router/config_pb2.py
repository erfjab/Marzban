...
CIDR = _reflection.GeneratedProtocolMessageType(
    "CIDR",
    (_message.Message,),
    {
        "DESCRIPTOR": _CIDR,
...
GeoIP = _reflection.GeneratedProtocolMessageType(
    "GeoIP",
    (_message.Message,),
    {
        "DESCRIPTOR": _GEOIP,
...
GeoIPList = _reflection.GeneratedProtocolMessageType(
    "GeoIPList",
    (_message.Message,),
    {
...
GeoSite = _reflection.GeneratedProtocolMessageType(
    "GeoSite",
    (_message.Message,),
    {
        "DESCRIPTOR": _GEOSITE,
...
GeoSiteList = _reflection.GeneratedProtocolMessageType(
    "GeoSiteList",
    (_message.Message,),
    {
...
BalancingRule = _reflection.GeneratedProtocolMessageType(
    "BalancingRule",
    (_message.Message,),
    {
...
StrategyWeight = _reflection.GeneratedProtocolMessageType(
    "StrategyWeight",
    (_message.Message,),
    {
...
StrategyLeastLoadConfig = _reflection.GeneratedProtocolMessageType(
