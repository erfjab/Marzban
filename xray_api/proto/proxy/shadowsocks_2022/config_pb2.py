...
MultiUserServerConfig = _reflection.GeneratedProtocolMessageType(
...
RelayDestination = _reflection.GeneratedProtocolMessageType(
    "RelayDestination",
    (_message.Message,),
    {
...
RelayServerConfig = _reflection.GeneratedProtocolMessageType(
    "RelayServerConfig",
    (_message.Message,),
    {
